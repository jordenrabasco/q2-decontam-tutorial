...
-   To export any of the objects used within the tutorial, utilize the `qiime tools export` assoicated actions, the documentation for which can be found [here.](https://docs.qiime2.org/2024.10/tutorials/exporting/)
