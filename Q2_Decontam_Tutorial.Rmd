...
The first action that will be run is `dectonam-identify`. This action runs the functionality of the base Decontam application. You will need to decide which method of Decontam you would like to run; Frequency, Prevalence, or Combined. An in depth explanation of the functionality of each method can be found [here](https://benjjneb.github.io/decontam/vignettes/decontam_intro.html)\
